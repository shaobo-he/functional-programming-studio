...
(define not-solvable-small (make/real-board "0 1
    2 0"))

(define simple (make/real-board "1 0
0 0"))

(define the-most-difficult-known
  (make/real-board
   "8 5 0 0 0 2 4 0 0
7 2 0 0 0 0 0 0 9
0 0 4 0 0 0 0 0 0
...
(define the-most-difficult-created
  (make/real-board
   "0 0 5 3 0 0 0 0 0
8 0 0 0 0 0 0 2 0
0 7 0 0 1 0 5 0 0
